...
/**
 * Created by jonathan on 22/02/2017.
 */
public class Database{
    ...
    {
        String[] countries = {"Afghanistan", "Albania", "Algeria", "Andorra", "Angola", "Anguilla",
                "Antigua & Barbuda", "Argentina", "Armenia", "Australia", "Austria", "Azerbaijan", "Bahamas",
                "Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan",
                "Bolivia", "Bosnia & Herzegovina", "Botswana", "Brazil", "Brunei Darussalam", "Bulgaria", "Burkina Faso",
                "Myanmar/Burma", "Burundi", "Cambodia", "Cameroon", "Canada", "Cape Verde", "Cayman Islands", "Central African Republic",
        ...
        for (int i = 0; i < countries.length; i++) {
            System.out.println("INSERT INTO Countries\n VALUES(" + (i+1) + ",'" + countries[i] + "');" );
            System.out.println();
        }
    }
}
